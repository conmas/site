...
But there are other corners of macOS where this kind of cavalier get-with-the-program mentality won’t fly. iTunes is a good example because it clearly demonstrates how the needless complexity of one system can be replaced by something more modern and usable in one fell swoop. But there are other options that aren’t as pretty.
